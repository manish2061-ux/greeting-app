        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="server-actions">
              ...
              <AccordionContent>
                <p>
                  Server Actions are asynchronous functions executed on the server. In this app, we use a Server Action
                  to process the name input and return a greeting. The action is called directly from the form
                  submission, demonstrating Next.js 15&apos;s enhanced form handling capabilities. [^1]
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="nextjs">
              ...
              <AccordionContent>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  ...
                  <li>Enhanced form handling with next/form</li>
